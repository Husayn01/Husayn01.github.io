const cardData = [
  {
    ...
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cum nemo, voluptatum ea libero, rerum ad ab? Odio, dicta dignissimos laudantium id autem aliquam iure quas",
    imageUrl: "images/Projects/WhatsApp Group Analysis.png",
    tools: ["ArcGIS Pro", "QGIS", "Google Earth", "MapInfo", "GeoServer"],
    links: [
      { url: "https://example.com/research-tools", text: "Read More" }
    ]
  },
  {
